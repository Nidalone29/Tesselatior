...
glm::vec3 AmbientLight::color() const { return _color; }

float AmbientLight::intensity() const { return _intensity; }
...
glm::vec3 DirectionalLight::color() const { return _color; }

glm::vec3 DirectionalLight::direction() const { return _direction; }
...
float DiffusiveLight::intensity() const { return _intensity; }
...
void SpecularLight::inc_shine(float value) { _shininess += value; }
...
float SpecularLight::intensity() const { return _intensity; }

float SpecularLight::shininess() const { return _shininess; }